...
const (
	...
	ES_URL          = "http://35.196.69.211:9200"
	BUCKET_NAME     = "wengq-project"
	ENABLE_BIGTABLE = false
	PROJECT_ID      = "around-225716"
...
func saveToBigTable(p *Post, id string) {
	...
	bt_client, err := bigtable.NewClient(ctx, "around-225716", "around-post", option.WithCredentialsFile("Around-d7821bac63f7.json"))
	if err != nil {
		panic(err)
		return
	}
